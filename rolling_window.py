...
# ### References
# 
# [1] A. R. Voelker and C. Eliasmith, "Improving spiking dynamical networks: Accurate delays, higher-order synapses, and time cells", Neural Computation (preprint), accepted 09 2017. [[URL](https://github.com/arvoelke/delay2017)]
